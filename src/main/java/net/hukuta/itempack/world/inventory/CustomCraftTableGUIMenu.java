...
package net.hukuta.itempack.world.inventory;
...
import net.hukuta.itempack.init.HukutaItemPackModMenus;
...
public class CustomCraftTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CustomCraftTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 25, 28) {
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 133, 28) {
			@Override
